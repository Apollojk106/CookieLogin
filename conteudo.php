...
<body>
    <div class="container">
        ...
        <p>"<?php echo $_COOKIE['user'] ?>" Explore the mystical world of Elden Ring, a dark fantasy action RPG developed by FromSoftware. Uncover ancient secrets, battle fearsome creatures, and forge your destiny as an Elden Lord.</p>
